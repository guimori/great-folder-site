(function () {
  ...
  const translations = {
    "pt-BR": {
      ...
      support_page_install_note: "Se o problema foi na instalacao, diga exatamente qual aviso apareceu no Windows e, se puder, envie um print junto com o email.",
    ...
    "en-US": {
      ...
      support_page_install_note: "If the problem happened during installation, say exactly which Windows warning appeared and, if possible, include a screenshot in the email.",
