(function () {
  ...
  const translations = {
    "pt-BR": {
      ...
      pricing_list_1: "licença vitalícia",
      ...
      download_copy: "Esta página já está preparada para concentrar o instalador e as próximas versões do programa.",
      download_note: "Depois, conecte a entrega do .exe ao pós-compra escolhido.",
      checkout_missing: "Checkout da Kiwify ainda não configurado. Preencha checkoutUrl em site-config.js.",
      checkout_ready: "Checkout da Kiwify configurado e pronto para este país.",
    },
    "en-US": {
      page_title: "Great Folder",
