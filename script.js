(function () {
  ...
  const translations = {
    "pt-BR": {
      ...
      pricing_install_note: "O instalador e entregue pelo greatfolder.com. Em alguns PCs, o Windows pode pedir uma confirmacao extra antes de abrir.",
      ...
      download_install_note: "Se o Windows pedir uma confirmacao extra, abra \"Mais informacoes\" e continue por \"Executar assim mesmo\".",
      faq_eyebrow: "FAQ",
      ...
      faq_q9: "O Windows mostrou um aviso ao abrir o instalador. O que eu faco?",
      faq_a9: "Baixe sempre pelo greatfolder.com. Se o Windows exibir uma tela de protecao, clique em \"Mais informacoes\" e depois em \"Executar assim mesmo\". Se preferir, envie um print na pagina de suporte antes de continuar.",
    ...
    "en-US": {
      ...
      pricing_install_note: "The installer is delivered through greatfolder.com. On some PCs, Windows may ask for one extra confirmation before opening it.",
      ...
      download_install_note: "If Windows asks for one extra confirmation, open \"More info\" and continue with \"Run anyway\".",
      faq_eyebrow: "FAQ",
      ...
      faq_q9: "Windows showed a warning when I opened the installer. What should I do?",
      faq_a9: "Always download from greatfolder.com. If Windows shows a protection screen, click \"More info\" and then \"Run anyway\". If you prefer, send a screenshot on the support page before continuing.",
